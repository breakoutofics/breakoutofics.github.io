...
BreakoutICS.writingCenter = {
    ...
    create: function() {
        ...
        this.introText = [
            ...
            "By appointment only 2:00pm - 3:00pm"
    ...
    mathTutor: function() {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 0.4, function() {
            ...
            this.game.state.start("writingTutor", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
