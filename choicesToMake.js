...
BreakoutICS.choicesToMake = {
    ...
    mommyTalking: function() {
        ...
        this.momHelpPls = [
            "I should check out the Math Lab",
            "I should check out the Writing Center",
            "I should check out the LRC",

            "I have to Breakout of ICS with Straight A's"
        ];
    ...
    mapOfLeeward: function() {
        BreakoutICS.game.global.goBackToEx = true;
        this.click.play();
        this.game.state.start("mapOfLeeward", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
        console.log("clicking mapOfLeeward");
    },
