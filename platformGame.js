...
BreakoutICS.GameState = {
    ...
    create: function() {
        var backgroundPic = this.game.add.image(0, 0, "leewardField");
        var backgroundPic2 = this.game.add.image(1025, 0, "leewardField");
        var backgroundPic3 = this.game.add.image(1025 * 2, 0, "leewardField");
        var backgroundPic4 = this.game.add.image(1025 * 3, 0, "leewardField");
        var backgroundPic5 = this.game.add.image(1025 * 4, 0, "leewardField");
        var backgroundPic6 = this.game.add.image(1025 * 5, 0, "leewardField");
        var backgroundPic7 = this.game.add.image(1025 * 6, 0, "leewardField");
        var backgroundPic8 = this.game.add.image(1025 * 7, 0, "leewardField");

        //backgroundPic.anchor.set(0.5);
        backgroundPic.scale.setTo(1, 1.5);
        backgroundPic2.scale.setTo(1, 1.5);
        backgroundPic3.scale.setTo(1, 1.5);
        backgroundPic4.scale.setTo(1, 1.5);
        backgroundPic5.scale.setTo(1, 1.5);
        backgroundPic6.scale.setTo(1, 1.5);
        backgroundPic7.scale.setTo(1, 1.5);
        backgroundPic8.scale.setTo(1, 1.5);
    ...
    update: function() {
        ...
        if (this.momText) {
            this.momText.x = Math.floor(this.player.x + this.player.width / 2 - 40);
            this.momText.y = Math.floor(this.player.y + this.player.height / 2 - 120);
        }
        ...
        /*if (this.playerAlive) {
            this.game.physics.arcade.overlap(this.player, this.fires, null, function(p, f) {
                ...
                //BreakoutICS.game.state.start('Game');
            }, this);
        }*/
        ...
        if (this.playerAlive) {
            this.game.physics.arcade.overlap(this.player, this.waters, function(player, waters) {
                ...
                //this.game.bgMusic.stop();
                console.log('auch!');
                BreakoutICS.game.state.start('platformGame');
            }, null, this);
        }
        ...
        if (this.playerAlive) {
            this.game.physics.arcade.overlap(this.player, this.hat, null, function(p, h) {
                ...
                this.cheer.play();
                this.hat.destroy();
                BreakoutICS.game.state.start('Win');
            }, this);
        }
        ...
        if (this.playerAlive) {
            this.game.physics.arcade.overlap(this.player, this.godzilla, null, function(p, g) {
                ...
                //BreakoutICS.game.state.start('TitleScreen');
            }, this);
        }
    ...
    mommyTalking: function() {
        ...
        this.momText = this.game.add.text(this.game.width / 2 + 100, this.game.height / 2 + 50, this.momRandomHelpPls, this.momTextStyle);
    ...
    titleText: function() {
        ...
        var alohaText = this.game.add.text(500, this.game.height / 2 - 150, randomAlohaText, styleForSecondText);
    ...
    loadLevel: function() {
        ...
        paralax1 = this.game.add.tileSprite(0, 800, 6300, 816, '');
        paralax2 = this.game.add.tileSprite(0, 400, 6300, 816, '');
        ...
        var sampleFisha = new BreakoutICS.Fish(this.game, 3020, 400, "pufferFish", undefined);
        this.jumpingFishes.add(sampleFisha);
        this.jumpingFishes.scale.setTo(0.7);
        //add fish1
        var sampleFish = new BreakoutICS.Fish(this.game, 3050, 400, "pufferFish", undefined);
        this.jumpingFishes.add(sampleFish);
        this.jumpingFishes.scale.setTo(0.5);
        //add fish2
        var sampleFish2 = new BreakoutICS.Fish(this.game, 3455, 400, "pufferFish", undefined);
        this.jumpingFishes.add(sampleFish2);
        this.jumpingFishes.scale.setTo(0.5);
        //add fish3
        var sampleFish2 = new BreakoutICS.Fish(this.game, 3855, 400, "pufferFish", undefined);
        this.jumpingFishes.add(sampleFish2);
        this.jumpingFishes.scale.setTo(0.5);
        //add fish4
        var sampleFish2 = new BreakoutICS.Fish(this.game, 4000, 400, "pufferFish", undefined);
        this.jumpingFishes.add(sampleFish2);
        this.jumpingFishes.scale.setTo(0.5);
        //add fish4
        var sampleFish2 = new BreakoutICS.Fish(this.game, 7000, 400, "pufferFish", undefined);
        this.jumpingFishes.add(sampleFish2);
        this.jumpingFishes.scale.setTo(0.5);
        ...
        var monster = new BreakoutICS.Monsters(this.game, 700, this.game.height / 2, "smallMonster", undefined, 800, 90);
        ...
        var monster = new BreakoutICS.Monsters(this.game, 900, this.game.height / 2, "smallMonster", undefined, 1000, 600);
        monster.animations.add("monsterWalk", [0, 1, 2, 3, 4, 5, 6], 10, true);
        monster.play("monsterWalk");
        //sampleCat.tint =  this.tintCatColor;
        this.monsters.add(monster);
        //this.monsters.scale.setTo(0.3);
        var monster = new BreakoutICS.Monsters(this.game, 6500, this.game.height / 2, "monster", undefined, 7000, 6000);
        monster.animations.add("monsterWalk", [0, 1, 2, 3, 4, 5, 6], 10, true);
        monster.play("monsterWalk");
        //sampleCat.tint =  this.tintCatColor;
        this.monsters.add(monster);
        ...
        var sampleCat = new BreakoutICS.Cats(this.game, 6500, this.game.height / 2 + 150, "cat", undefined);
        sampleCat.animations.add("catWalk", [0, 1], 4, true);
        sampleCat.play("catWalk");
        //sampleCat.tint =  this.tintCatColor;
        this.friendlyCats.add(sampleCat);
        //add sampleCat2
        var sampleCat2 = new BreakoutICS.Cats(this.game, 6400, this.game.height / 2 + 150, "cat", undefined);
        ...
        //create goal with throbbing tween
        this.hat = this.add.sprite(7200, this.game.height / 2 + 150, "flag");
        this.hat.anchor.set(0.5);
        this.hat.scale.setTo(1, 1);
        ...
        //create player.
        this.player = this.add.sprite(120, 210, 'player', 5);
