...
BreakoutICS.mathTutor = {
    ...
    create: function() {
        ...
        var mathLabMap = this.game.add.image(this.game.width / 2, this.game.height / 2, "mathLabPic");
        ...
        this.mathTutor = this.add.sprite(this.game.width - 130, this.game.height / 2 + 60, 'mathLabTutor', 7);
        ...
        this.introText = [
            ...
            "\t\t\t\tMy name's Mary, i'm a Math Tutor",
            "\t\t\t\tHow can I help you?",
            "  \t\t\t\t  ",
            "Hi Mary, my name's Tim",
            "\t\t\t\tIs it possible if you could help me",
            "\t\t\t\twith some algebra concepts?",
            "  \t\t\t\t  ",
            "You bettcha!, Algebra is Awesome!"
    ...
    infoTwoDialogState: function() {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 0.4, function() {
            ...
            this.game.state.start("codingScreenMath", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
