...
BreakoutICS.talkToGf = {
    ...
    create: function() {
        ...
        this.mathTutor = this.add.sprite(this.game.width-130, this.game.height / 2+200, 'girlStanding', 7);
        this.mathTutor.anchor.setTo(0.5);
        this.mathTutor.alpha = 0;
        this.mathTutor.scale.setTo(-1.7, 1.7);
...
// TEXT Mary END ----------------------------------------------------------------------------------------------------------------
    ...
    infoTwoDialogState: function() {
        ...
        BreakoutICS.game.global.hadLunch = true;
        this.click.play();
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 0.4, function() {
            ...
            this.game.state.start("eatLunch", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
