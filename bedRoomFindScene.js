...
BreakoutICS.bedRoomFindScene = {
    ...
    create: function() {
        ...
        var backgroundPic = this.game.add.image(this.game.width / 2, this.game.height / 2, "bedRoomScreen");
    ...
    loadLevel: function() {
        ...
        //create girl 
        this.girl = this.add.sprite(40, this.game.height / 2 + 89, "girlWalking", 5);
        this.girl.anchor.setTo(0.5);
        //this.girl.scale.setTo(1.5, 1.5);
        ...
        // charger
        this.charger = this.add.sprite(this.game.width / 2 + 270, this.game.height - 280, "charger");
        this.charger.anchor.set(0.5);
        this.charger.scale.set(1);
        this.charger.inputEnabled = true;
        this.charger.useHandCursor = true;

        // laptop
        this.lapTop = this.add.sprite(this.game.width / 2 + 250, this.game.height - 300, "laptop");
        this.lapTop.anchor.set(0.5);
        this.lapTop.scale.set(1);
        this.lapTop.inputEnabled = true;
        this.lapTop.useHandCursor = true;

        // keys
        this.keys = this.add.sprite(this.game.width / 2 - 240, this.game.height / 2 + 20, "keys");
        this.keys.anchor.set(0.5);
        this.keys.scale.set(1);
        ...
        this.updateUrMonies = this.add.text(this.game.width / 2, 40, "Get your stuff", this.style);
    ...
    goLivingRoom: function() {
        if (this.player.body.x >= this.game.width - 80) {
            ...
            this.game.state.start("livingRoom", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
        }
    },

    foundAllStuff: function() {
        if (BreakoutICS.game.global.stuff == 3) {
            console.log("HI");
            this.game.state.start("livingRoom", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
        }
    },
