...
BreakoutICS.mapOfLeeward = {
    ...
    create: function() {
        ...
        var mathLabMap = this.game.add.image(0, 0, "mapOfLeewardUpper");
        //mathLabMap.anchor.set(0.5);
        mathLabMap.scale.setTo(0.7, 1);
        ...
        //create player.
        this.player = this.add.sprite(this.game.width / 2+30, this.game.height / 2+60, 'player', 7);
        ...
        this.introText = [
            ...
            "By appointment only 2:99pm - 3:00pm"
...
//        this.nextLine();
    ...
    mathTutor: function() {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 0.4, function() {
            ...
            this.game.state.start("mapOfLeewardLower", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
