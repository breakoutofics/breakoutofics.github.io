...
BreakoutICS.mathTest = {
    ...
    create: function() {
        ...
        var mathBackground = this.game.add.image(this.game.width / 2, this.game.height / 2);
        mathBackground.anchor.set(0.5);
        mathBackground.scale.setTo(0.3, 0.3);
        ...
        this.mathTutorGirl = this.add.sprite(this.game.width - 110, this.game.height / 2 + 60, 'mathLabTutor', 7);
        this.mathTutorGirl.anchor.setTo(0.5);
        this.mathTutorGirl.alpha = 0;
        this.mathTutorGirl.scale.setTo(0.5, 0.5);
        this.game.add.tween(this.mathTutorGirl).to({ alpha: 1 }, 1000, Phaser.Easing.Linear.None, true);
        // Writing Tutor END ------------------------------------------------
        ...
        this.blueButtonOne = this.game.add.button(blueButtonOnePositionX, blueButtonOnePositionY, "blueButton", this.BUTTONCorrect, this);
        ...
        this.blueButtonThree = this.game.add.button(blueButtonThreePositionX, blueButtonThreePositionY, "blueButton", this.BUTTONIncorrect, this);
        ...
        var blueButtonThreeText = "FG 205";
        ...
        this.introText = [
            "     ",
            "Well Done with your Assignment!",
            "Now, Here's a QUIZ on the Math Lab",
            "\t\t\t\t\t\tWhere is the Math Located?"
    ...
    BUTTONIncorrect: function() {
        this.click.play();
        this.Aww.play();
        BreakoutICS.game.global.MathPassed = false;
    ...
    BUTTONCorrect: function() {
        this.cheer.play();
            BreakoutICS.game.global.MathPassed = true;
            var blueButtonOnePositionX = this.game.width / 2;
            var blueButtonOnePositionY = this.game.height / 2 - 30;
    ...
    infoTwoDialogState: function() {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 0.4, function() {
            ...
            this.game.state.start("mathTest", Phaser.Plugin.StateTransition.Out.SlideRight, Phaser.Plugin.StateTransition.In.SlideRight);
